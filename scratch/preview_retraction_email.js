...
async function generatePreview() {
  ...
  const accessCode = "AB12CD";
  const appUrl = "https://babypita.vercel.app";
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <div style="padding: 20px; background-color: #ffffff; border: 1px solid #fcf8f2;">
        ...
        <div style="margin: 30px 0; padding: 20px; background-color: #f0f8ff; border-radius: 8px; text-align: center;">
          ...
          <a href="${appUrl}/#presentes" style="display: inline-block; padding: 12px 24px; background-color: #f6b26b; color: white; text-decoration: none; font-weight: bold; border-radius: 20px; margin-top: 10px;">Ver Lista de Presentes</a>
        </div>
        ...
        <div style="margin: 30px 0; padding: 20px; background-color: #fff9f9; border-radius: 8px; text-align: center; border: 1px dashed #f6b26b;">
          ...
          <a href="${appUrl}/#mural" style="display: inline-block; padding: 12px 24px; background-color: #6fa8dc; color: white; text-decoration: none; font-weight: bold; border-radius: 20px; margin-top: 10px;">Deixar Recado</a>
        </div>
  ...
  console.log("Preview salvo em email_preview.html");
}
